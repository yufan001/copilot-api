/* eslint-disable complexity, max-lines-per-function, max-depth, eqeqeq, @typescript-eslint/no-unnecessary-condition, @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-argument, @typescript-eslint/restrict-plus-operands, no-nested-ternary, @typescript-eslint/no-explicit-any */
import {
  APICallError,
...
export class OpenAICompatibleChatLanguageModel implements LanguageModelV2 {
  ...
  async doStream(
    ...
    const body = {
      ...
      stream_options:
        this.config.includeUsage ? { include_usage: true } : undefined,
    }
